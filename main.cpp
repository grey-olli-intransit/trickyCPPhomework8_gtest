...
#include <algorithm>
#include <sstream>
//#include "/home/olli/.conan/data/gtest/cci.20210126/_/_/package/63868df56b76903d4ad40ecbd5b2e8238cee50c9/include/gtest/gtest.h"
...
protected:
    ...
    void SetUp() override {
        ...
        samplePerson->SecondName="Ilin";
        samplePerson->FirstName="Petr";
        samplePerson->Patronymic="Artemovich";
    }
...
TEST_F(TestPerson, ChecksForPersonAssignment) {
    ASSERT_EQ(samplePerson->FirstName,"Petr");
};
